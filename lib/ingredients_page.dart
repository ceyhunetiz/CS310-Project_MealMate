...
import 'package:provider/provider.dart'; // <--- Added for Database Logic
import 'services/database_service.dart'; // <--- Added for Database Logic
import 'models/meal.dart'; // <--- Added for Meal Model
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // --- UPDATED LOGIC INJECTED HERE (Keeps Original UI Container) ---
            Expanded(
              child: Container(
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                ...
                child: StreamBuilder<List<Meal>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final filteredMeals = allMeals.where((meal) {
                      ...
                      // Returns true if they share ANY ingredient
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Column(
                          children: [
                            // Use YOUR original card widget
                            _buildRecipeCard(context, meal.title, meal.price, meal.time),
  ...
  Widget _buildRecipeCard(BuildContext context, String name, String price, String time) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Colors.grey[700], // Preserved your dark grey color
