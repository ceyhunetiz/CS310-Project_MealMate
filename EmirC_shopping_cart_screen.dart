...
class EmirCShoppingCartScreen extends StatefulWidget {
  const EmirCShoppingCartScreen({Key? key, this.missingItems}) : super(key: key);
...
class _EmirCShoppingCartScreenState extends State<EmirCShoppingCartScreen> {
  ...
  void initState() {
    ...
    // Keep only the requested items when provided so that navigation feels intentional.
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isSelected ? const Color(0xFF4C9CFF) : const Color(0xFFE0E0E0),
